      ...
      <div className="overview-grid">
        ...
        <Card className="overview-wide">
          ...
          <div className="service-grid">{data.services.map(service => {
            const icon: IconName = service.id === "server" ? "connections" : service.id === "prompt" ? "prompts" : service.id === "file-manager" ? "files" : "models";
            const href = service.id === "server" ? "/server/connections" : service.id === "prompt" ? "/prompts" : service.id === "file-manager" ? "/files" : "/llama/models";
